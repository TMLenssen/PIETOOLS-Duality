...
\begin{figure*}[t]
 ...
 \caption{Reproduction of the \cite[Fig.~7]{veenman2016robust} sweep for the coupled heat
 equations: primal analysis(left), dual analysis (center), and the
 difference between primal and dual $\gamma-\underline{\gamma}$ (right).
 Since $\Theta$ need not be $\mbf{D}(\underline{\Theta})$ primal and dual optimization
 problems need not have the same optimal value.}
...
\begin{figure}[t]
 ...
 equation (left) and damped wave equation (right). The dashed gray curve
 is $w_{\mrm p}(t)$.}
