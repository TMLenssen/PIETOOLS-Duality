...
{p_T \mcl{M}_{\underline{\mcl V}_\Delta}\bmat{P^\top\underline{w}_\Delta \\ \underline{w}_\Delta}}_{L_{[a,b]}}
\end{equation*}
...
Since $\underline{S}_0> 0$, $\underline{\mcl{S}}$ is closed under inversion with ${\underline{S}_0}^{-1}> 0$. 
...
\begin{equation*}
    (\beta z_\Delta(t,s)-\phi(z_\Delta(t,s)))
    (\phi(z_\Delta(t,s))-\alpha z_\Delta(t,s))\geq0,
\end{equation*}
and hence
\begin{equation*}
    (\beta z_\Delta(t,s)-\phi(z_\Delta(t,s)))\underline S^{-1}_0(s)
    (\phi(z_\Delta(t,s))-\alpha z_\Delta(t,s))\geq0.
\end{equation*}
