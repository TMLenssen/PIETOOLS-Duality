...
of interconnected systems in a Hilbert space. We establish the generalized
system interconnection, formalize stability and performance, and define the
uncertainty and performance IQCs. These definitions provide the foundation for
the primal-system analysis in Section~\ref{sec:primal-controller-analysis}.
...
with 
\begin{equation*}
\ip{p_T \Psi_{\mathrm{p}}\bmat{P_{\mathrm{p}\Delta}\\ 0}w_{\mathrm{p}}}{p_T\mcl{M}_{\mcl V_{\mathrm{p}}}\Psi_{\mathrm{p}}\bmat{P_{\mathrm{p}\Delta}\\ 0}w_\mathrm{p}}_{\mbf L_{[a, b]}}
\geq 0.
\end{equation*} for all $w_{\mathrm{p}}\in\mbf{L}_{e,[a,b]}^{\mbf{n}_{w_\mathrm{p}}}$. Then there exists a sufficiently
...
$\mcl{M}_{{\mcl{V}}_{\mathrm{p}}}$, in Definition~\ref{def:robust-performance}, if,
