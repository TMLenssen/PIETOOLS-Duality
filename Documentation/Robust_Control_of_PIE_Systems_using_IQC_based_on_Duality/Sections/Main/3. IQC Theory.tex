...
$w\in L_{\mrm{e}, [a,b]}$, there exist unique
$z\in L_{\mrm{e}, [a,b]}$,
$z_\Delta \in L_{\mrm{e}, [a,b]}$ and
$w_\Delta \in  L_{\mrm{e}, [a,b]}$ such that, $z$, $w$,
...
and 
the bounded self-adjoint operator $\mcl{V}_\Delta = \mcl{V}_\Delta^*$
...
is {robustly stable} and for performance IQC $(\Psi_{\mrm{p}}, \mcl M_{\mcl V_{\mrm{p}}})$ defined by $\Psi_{\mrm{p}}:
...
$\mcl{V}_{\mrm{p}}=\mcl{V}_{\mrm{p}}^*$, such that
\[\ip{p_T \Psi_{\mrm{p}}\bmat{v \\ 0}}{p_T\mcl{M}_{\mcl V_{\mrm{p}}}\Psi_{\mrm{p}}\bmat{v\\ 0}}_{L_{[a,b]}}\geq \epsilon\]
...
${{\mcl{V}}_{\mrm{p}}} =\{\mcl Q_{\mrm{p}}, \mcl S_{\mrm{p}}, \mcl R_{\mrm{p}}\}$, with
$\mcl{Q}_{\mrm{p}} \succeq 0$, if,
