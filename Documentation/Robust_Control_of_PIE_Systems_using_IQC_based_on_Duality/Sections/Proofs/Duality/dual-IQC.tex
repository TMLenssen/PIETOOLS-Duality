...
$1)\implies2)$ Assume there exists a $0<\rho<1$ such that
$\|p_T G_0\tilde w\|_{\mbf{L}}\leq\rho\|p_T \tilde w\|_{\mbf{L}}$
for all $\tilde{w}\in \mbf{L}$ and $T\geq0$. We need to show that
$\mcl I\leq-\epsilon\|p_Tw\|_{\mbf{L}}^2$ for some $\epsilon>0$. First since $\Gamma$ is causally boundedly invertible,
$\Theta\bmat{P\\I}w=\bmat{G_0\\I}\Gamma w$, and hence
$\mcl I=\|p_TG_0\Gamma  w\|_{\mbf{L}}^2-\|p_T\Gamma  w\|_\mbf{L}^2$. By statement 1 and causality of $G_0$,
\[
    \mcl I\leq-(1-\rho^2)\|p_T\Gamma w\|_{\mbf{L}}^2
    \leq-\frac{1-\rho^2}{\|\Gamma^{-1}\|_{\mcl{L}(\mbf{L})}^2}\|p_Tw\|_{\mbf{L}}^2,
\]
where the second inequality follows from
$\|p_Tw\|_{\mbf{L}}=\|p_T\Gamma^{-1}p_T\Gamma w\|_{\mbf{L}}
\leq\|\Gamma^{-1}\|_{\mcl{L}(\mbf{L})}\|p_T\Gamma w\|_{\mbf{L}}$. Thus, $\epsilon=\frac{(1-\rho^2)}{\|\Gamma^{-1}\|_{\mcl{L}(\mbf{L})}^2}>0$.

$2)\implies1)$ Assume that there exists a $\epsilon > 0$ such that $\mcl I\leq-\epsilon\|p_Tw\|_{\mbf{L}}^2$ for every $w$, and every $T\geq0$. 
We need to establish there exists a $0<\rho<1$ such that
$\|p_T G_0\tilde w\|_{\mbf{L}}\leq\rho\|p_T \tilde w\|_{\mbf{L}}$
for all $\tilde{w}\in \mbf{L}$ and $T\geq0$. For arbitrary $\tilde w$, 
set $w=\Gamma^{-1}\tilde w$. Then
\[
    \|p_TG_0\tilde w\|_{\mbf{L}}^2-\|p_T\tilde w\|_{\mbf{L}}^2
    \leq-\epsilon\|p_T\Gamma^{-1}\tilde w\|_{\mbf{L}}^2.
\]
Since $\Gamma$ is bounded and causal,
$\|p_T\tilde w\|_{\mbf{L}}\leq
\|\Gamma\|_{\mcl{L}(\mbf{L})}\|p_T\Gamma^{-1}\tilde w\|_{\mbf{L}}$. Therefore,
\[
    \|p_TG_0\tilde w\|_{\mbf{L}}^2
    \leq\left(1-\frac{\epsilon}{\|\Gamma\|_{\mcl{L}(\mbf{L})}^2}\right)
    \|p_T\tilde w\|_{\mbf{L}}^2.
\]
Choose $0<\rho<1$ such that $1-\epsilon/\|\Gamma\|^2\leq\rho^2<1$, 
then $\|p_TG_0\tilde w\|_{\mbf{L}}\leq\rho\|p_T\tilde w\|_{\mbf{L}}$
...
same induced $L_2$-gain. Hence, for any $\rho>0$,
\[
\begin{aligned}
&\|p_TG_0\tilde w\|_{\mbf L}
 \leq\rho\|p_T\tilde w\|_{\mbf L}
 \quad\text{for all $\tilde w$ and $T\geq0$}
&\qquad\Longleftrightarrow\qquad
\|p_TG_0^\top\underline{\tilde w}\|_{\mbf L}
 \leq\rho\|p_T\underline{\tilde w}\|_{\mbf L}
...
=
\bmat{\mcl A&\mcl B\\\mcl C_z&\mcl D_z\\
\mcl C_w&\mcl D_w}
\bmat{\mbf x\\w}.
\]
If $\mcl D_w$ is invertible, eliminating $w$ gives the realization
\begin{equation}\label{eq:G0-primal-realization}
G_0\sim
\left\{
\mcl T,
\mcl A-\mcl B\mcl D_w^{-1}\mcl C_w,
\mcl B\mcl D_w^{-1},
\mcl C_z-\mcl D_z\mcl D_w^{-1}\mcl C_w,
\mcl D_z\mcl D_w^{-1}
\right\},
\end{equation}
