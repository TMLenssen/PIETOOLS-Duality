...
\draw[equiv] (PrimalFilteredBox.south) -- node[midway, right, xshift=0.16cm]
    {(Theorem~\ref{thm:primal-dual-iqc-feasibility})} (DualFilteredBox.north);
...
Potapov--Ginzburg transform. \cite{venkataraman}}
